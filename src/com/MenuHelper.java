...
import com.actions.*;
import com.listeners.TextEditMenuListener;
import com.listeners.UndoMenuListener;
...
public class MenuHelper {
    public static JMenuItem addMenuItem(JMenu parent, String text, ActionListener actionListener) {
        ...
        /*
        Registers the action listener for the menu item which will be notified whenever the user clicks on the menu item.
        For this project the view will be the action listener.
         */
    ...
    /*
    initHelpMenu() - This method initializes the help menu. It adds a Help menu to the menu bar and adds the About menu
    ...
    /*
    initFontMenu() - This method initializes the font menu.
     */
    public static void initFontMenu(View view, JMenuBar menuBar) {
        // Adds a Font menu to the menu bar
        JMenu fontMenu = new JMenu("Font");
        menuBar.add(fontMenu);

        // Adds a Font Type menu to the Font menu
        JMenu fontTypeMenu = new JMenu("Font");
        fontMenu.add(fontTypeMenu);

        /*
        Adds menu items for 5 different types of fonts to the Font Type menu. FontFamilyAction sets the font for the editor
        pane.
         */
        ...
        /*
        Adds menu items for the various font sizes to the Font Size menu. FontSizeAction sets the font size for the editor
        pane.
         */
    ...
    /*
    initColorMenu() - This method initializes the color menu.
     */
    public static void initColorMenu(View view, JMenuBar menuBar) {
        JMenu colorMenu = new JMenu("Color");
        menuBar.add(colorMenu);

        //Adds a new menu item and sets a ForegroundAction for the various colors.
    ...
    /*
    initAlignMenu() - This method initializes the align menu
     */
    public static void initAlignMenu(View view, JMenuBar menuBar) {
        JMenu alignMenu = new JMenu("Align");
        menuBar.add(alignMenu);

        // Adds a menu item and sets an AlignmentAction for each of the alignments.
    ...
    /*
    initStyleMenu() - This method initializes the style menu
     */
    ...
    /*
    initEditMenu() - This method initializes the edit menu
     */
    ...
    /*
    initFileMenu() - This method initializes the file menu
     */
